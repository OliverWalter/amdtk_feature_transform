...
#def utt2spk_line(key, _):
    ...
    #utterance id to be in the form 'X_Y_Z_A', where 'X_Y_Z' is the speaker id.
    #Everything after 'X_Y_Z' will be cut of.
    ...
    #"""
    #return '{} {}\n'.format(key, '_'.join(key.split('_')[:3]))


def utt2spk_line(key, _):
    """ Get utterance id to speaker id antry. This function assumes utterance
    and speaker id to be the same
